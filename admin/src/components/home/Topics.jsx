...
function Topics() {
    ...
    const handleAddTopic = async (listName) => {
        ...
        try {
            ...
            const response = await axios.patch("https://admin.precision-omics.org/api/topics", updatedTopics, {
    ...
    const handleDeleteTopic = async (listName, topic) => {
        try {
            const response = await axios.delete(`https://admin.precision-omics.org/api/topics/${listName}/${topic}`);
