...
function Passes() {
    ...
    const handleAddOrUpdateBenefit = async (pass) => {
        ...
        if (updatedPasses.length === 0) {
            ...
            try {
                await axios.patch(`https://admin.precision-omics.org/api/passes`, {
    ...
    const handleDeleteBenefit = async (passType, passIndex, benefitIndex) => {
        try {
            const response = await axios.delete(
                `https://admin.precision-omics.org/api/passes/${passType}/${benefitIndex}`
            );
    ...
    const handleSubmit = async () => {
        try {
            await axios.patch("https://admin.precision-omics.org/api/passes", passesForm, {
