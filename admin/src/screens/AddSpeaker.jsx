...
const AddSpeaker = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        switch (formData.category) {
            case 'speaker':
                endpoint = 'https://admin.precision-omics.org/api/addSpeaker';
                break;
            case 'keynote':
                endpoint = 'https://admin.precision-omics.org/api/addKeynoteSpeaker';
                break;
            case 'committee':
                endpoint = 'https://admin.precision-omics.org/api/addCommittee';
                break;
            default:
                break;
        }
