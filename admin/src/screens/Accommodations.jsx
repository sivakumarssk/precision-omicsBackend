...
const Accommodations = () => {
  ...
  const fetchAccommodations = async () => {
    try {
      const response = await axios.get('https://admin.precision-omics.org/api/getAccommodations');
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        ...
        await axios.put(`https://admin.precision-omics.org/api/updateAccommodation/${editingId}`, formData);
        setSuccess('Accommodation updated successfully');
      } else {
        // Add new accommodation
        await axios.post('https://admin.precision-omics.org/api/addAccommodation', formData);
