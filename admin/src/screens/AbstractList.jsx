...
const AbstractList = () => {
    ...
    const fetchAbstractData = async () => {
        try {
            const response = await axios.get('https://admin.precision-omics.org/api/allAbstract'); // Replace with your backend URL
                        ...
                        {abstracts.map((abstract, index) => (
                            <tr key={index}>
                                ...
                                <td>
                                    {abstract.attachFile ? (
                                        <a
                                            href={`https://admin.precision-omics.org${abstract.attachFile}`}
                                            target="_blank"
