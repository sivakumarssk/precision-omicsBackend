...
import PastEventsList from './screens/PastEventsList'
  ...
  return (
    <div className='appMain'>
      ...
      <Routes>
        ...
        <Route path='/pastEvent' element={<ProtectedRoute><PastEvent /> </ProtectedRoute>} />
        <Route path='/pastEventsList' element={<ProtectedRoute><PastEventsList /> </ProtectedRoute>} />
      </Routes>
    </div>
  )
}
