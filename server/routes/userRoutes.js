...
const pastEventsController = require('../controlers/pastEventsController');

// Add or update an event (date and PDF)
router.post('/past-events/date-pdf',pastEventsController.addOrUpdateEvent);

// Add an image to an event
router.post('/past-events/image', pastEventsController.addEventImage);

// Delete an image from an event
router.delete('/past-events/image', pastEventsController.deleteEventImage);

// Delete an event
router.delete('/past-events/:eventDate', pastEventsController.deletePastEvent);

// Get all events
router.get('/past-events', pastEventsController.getAllPastEvents);

// Get details of a specific event
router.get('/past-events/:eventDate', pastEventsController.getPastEventDetails);
router.get('/event-with-images', pastEventsController.getLastEventWithImages);

router.get('/menus', pastEventsController.getDynamicMenu);
